...
(function () {
  ...
  const translations = {
    'pt-BR': {
      ...
      'projects.trilhapro.description': 'Protótipo web de orientação de carreira e aprendizagem personalizada. Amplia a proposta original da FIAP com dashboard, jornada de aprendizagem, detalhes de cursos, evolução e oportunidades.',
      'projects.carepredict.description': 'Protótipo web colaborativo para o challenge da Care Plus, focado em reduzir faltas a consultas com lembretes, reagendamento simplificado, gamificação e conceitos de previsão de agenda.',
    ...
    en: {
      ...
      'projects.trilhapro.description': 'Web prototype for personalized career guidance and technology learning. Expands the original FIAP proposal with a dashboard, learning journey, course details, progress tracking, and opportunities.',
      'projects.carepredict.description': 'Collaborative web prototype for the Care Plus challenge, focused on reducing appointment no-shows through reminders, simplified rescheduling, gamification, and predictive scheduling concepts.',
